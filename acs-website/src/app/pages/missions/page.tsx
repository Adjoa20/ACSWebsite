...
const MissonPage = () => {
  return (
    <div className="md:flex md:justify-center md:items-center md:gap-8 md:py-8 md:px-4 xl:gap-16 sm:py-16 xl:px-16 bg-missionbg bg-no-repeat h-screen bg-fixed">
      <Navbar />
