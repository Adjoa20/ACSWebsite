  ...
  return (
    <div className="md:flex md:justify-center md:items-center md:gap-8 md:py-8 md:px-4 xl:gap-16 sm:py-16 xl:px-16 bg-environmentbg bg-no-repeat h-screen bg-fixed">
      ...
      <div className="mt-52">
        ...
        <p>
          SWOT (Strengths; Weaknesses; Opportunities; Threat): SWOT analysis is
        ...
        <p>
          Strengths: Highly-skilled committed and concerned teachers. ACS
        ...
        <p>
          Excellent Programs: American Cooperative School has excellent programs
        ...
        <p>
          Strong academic drama and concert programs: American Cooperative
        ...
        <p>
          Use of Computers: Computer lessons are provided in the upper primary.
        ...
        <p>
          Strong Management Team: The executive director, administration
        ...
        <p>
          Weaknesses: Some staffs are not computers literate. American
        ...
        <p>
          School Website: In this modern society, internet has become one of the
        ...
        <p>
          Record keeping and recordings: At the moment, some of the students
        ...
        <p>
          Limited resources: American Cooperative School has limited resources.
        ...
        <p>
          Opportunities: Foreign volunteers: American Cooperative School is
        ...
        <p>
          Computers: Computers have been introduced to all schools in Ghana;
        ...
        <p>
          Threats: Incomplete staff mandatory training: There is a need to
        ...
        <p>
          Drop of Enrollment: American Cooperative School depends on students’
        ...
        <p>
          School transportation safety: Most of the students use the school
        ...
        <p>
          Staff retention: In general, teachers salary in Ghana is very low and
        ...
        <p>
          PESTLE (Political; Economic; Social/Cultural; Technology; Legal;
          Environment): The PESTLE Analysis is a tool that is used to identify
        ...
        <p>
          Political: Type of Government: Constitutional based democracy in Ghana
        ...
        <p>
          Government Free Education Initiative: As part of the Ghana
        ...
        <p>
          Changes to curriculum: All public and private schools follow the same
        ...
        <p>
          Economic: School fees: School fees average between $5 and $15 per
        ...
        <p>
          Cheap labor: In general, the average salary of a private school
        ...
        <p>
          Parents Income: Parents earning a minimum wage of $50 per month spend
        ...
        <p>
          Social/Cultural; Children population: Approximately 40% - 50% of the
          population in Ghana between the ages of 2 - 12 will fall in primary
          school’s target market.
        </p>
        <p>
          Parent preference: an increase in parent power has allowed parents
          more freedom of choice over their child’s school.
        </p>
        <p>
          Habits: Staffs are not given enough training or access to effectively
          change their habits and how they expected information to be made
          available.
        </p>
        <p>
          Technology Computer Technology: Ghana is not advanced in computer
        ...
        <p>
          Legal Raising or lowering the age starting or leaving school: Ghana's
        ...
        <p>
          Environment: School location: ACS is located in an area where it is
        ...
        <p>
          Competition: There are approximately forty eight schools in the
