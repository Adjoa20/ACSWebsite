...
const PolicyPage = () => {
  return (
    <div className="md:flex md:justify-center md:items-center md:gap-8 md:py-8 md:px-4 xl:gap-16 sm:py-16 xl:px-16 bg-policybg bg-no-repeat h-screen bg-fixed">
      <Navbar />
      <div className="md:w-1/2">
        <h1 className="mt-96 mb-60 uppercase">Policies</h1>
      </div>
      <div className="mt-52">
        <p>
