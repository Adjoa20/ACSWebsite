...
const EnrollmentPage = () => {
  return (
    <div className="md:justify-center">
      <Navbar />
      <div className="bg-enrollbg relative md:bg-cover h-screen md:h-full flex flex-col items-center justify-center" >
        ...
        <div className="px-4 mt-10 md:mt-10 mb-20">
          <div className="grid place-items-center grid-cols-1 w-full mx-auto max-w-5xl shadow-2xl rounded-2xl bg-[#fcf2eb] backdrop-blur-sm bg-opacity-30 mb-2 p-8">
